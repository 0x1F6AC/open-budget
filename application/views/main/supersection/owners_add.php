                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Mijoz ismini kiriting..." name="name" value="<?php echo $fields['name'];?>">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="formGroupExampleInput" class="d-block">Telegram ID</label>
                      <input type="text" class="form-control" placeholder="Teelgram indenfikatorini kiriting..." name="chat_id" value="<?php echo $fields['chat_id'];?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-select" name="status">
                        <option value="1" <?php if( $fields['status'] == 1 ) echo "selected";?>>Faol</option>
                        <option value="0" <?php if( $fields['status'] == 0 ) echo "selected";?>>Faol emas</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-select" name="level">
                        <option value="0" <?php if( $fields['level'] == 0 ) echo "selected";?>>Mijoz</option>
                        <option value="2" <?php if( $fields['level'] == 2 ) echo "selected";?>>Kuzatuvchi</option>
                        <option value="1" <?php if( $fields['level'] == 1 ) echo "selected";?>>Superadmin</option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" multiple="multiple" name="bots[]">
                        <?php
                          $bots = $this->db->get_where('bots', ['status' => '1']);
                          if ( $bots->num_rows() > 0 ) {
                            $selected_bots = explode(',', $fields['bots']);
