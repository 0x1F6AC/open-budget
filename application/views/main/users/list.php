<div class="content content-fixed">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
          <div>
            <h4 class="mg-b-0 tx-spacing--1">Foydalanuvchilar</h4>
          </div>
          <div class="d-md-block">
            <select class="form-select" onchange="return window.location.href = '<?php echo base_url();?>users/'+this.value" >
          ...
          <div class="col-lg-12 ">
              <?php
                  ...
                  $setings = [
                    ...
                    'serverMethod' => 'post',
                    'ajax' => [
                        'url' => base_url('ajax/users/list/'.$bot_id),
                        'cache' => false
                    ],
                    'columns' => [
                        ['title' => 'Nomi', 'data' => 'chat_id'],
                        ['title' => 'Havola', 'data' => 'username'],
                        ['title' => 'Ro\'yxatdan o\'tgan', 'data' => 'registered'],
                        ['title' => 'Oxirgi aktivlik', 'data' => 'lastaction'],
                  ...
                  echo dtable_gen('users', $attr, $setings);
              ?>
          </div><!-- col -->
        </div><!-- row -->
      </div><!-- container -->
    ...
    <div class="modal fade" id="userstats" tabindex="-1" role="dialog" aria-labelledby="userStats" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content tx-14">
          <div class="modal-header">
            <h6 class="modal-title" id="userStats">Statistika</h6>
