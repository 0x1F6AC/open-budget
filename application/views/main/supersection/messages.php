      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
          <div>
            ...
            <h4 class="mg-b-0 tx-spacing--1">Bot xabarlarini boshqarish</h4>
          </div>
          <div class="d-md-block">
            <a class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" href="<?php echo base_url();?>"><i data-feather="chevron-left" class="wd-10 mg-r-5"></i> orqaga</a>
          </div>
        </div>
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        ?>
                        <textarea class="form-control no-resize" rows="3" name="<?php echo $key;?>"><?php echo setting_item($key);?></textarea>
                      </div>
                    </div>
                  </div>
                  <?php
