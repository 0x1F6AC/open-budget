                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Bot nomi kiriting..." name="name" value="<?php echo $name;?>">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label for="formGroupExampleInput" class="d-block">Tashabbus</label>
                      <input type="text" class="form-control" placeholder="Tashabbus havolasini kiriting..." name="board" value="<?php echo $board;?>">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label for="formGroupExampleInput" class="d-block">Token</label>
                      <input type="text" class="form-control" placeholder="Bot tokenini kiriting..." name="token" value="<?php echo $token;?>">
                    </div>
                  </div>
                </div>
                <hr>
